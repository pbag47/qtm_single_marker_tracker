...
class Agent:
    def __init__(self, name, uri):
        ...
        self.kp_xy: float = 1
        self.kd_xy: float = 0.4

        self.kp_z: float = 32500
        self.ki_z: float = 8125
        self.kd_z: float = 16250
        self.previous_iz: float = 0.0
        self.thrust_at_steady_state: float = 38000

        self.kp_yaw: float = 1.0
    ...
    def set_consensus_connectivity(self, connections: List[str]):
        ...
        logger.debug(self.name + ' connectivity set')

    def set_xy_consensus_offset(self, offset: (float, float)):
        self.xy_consensus_offset = offset
        logger.debug(self.name + ' consensus offset set')
    ...
    def wingman_behaviour(self):
        logger.info(self.name + ' Switch to Wingman mode')
        self.state = 'Wingman'
        self.wingman_z = self.position.z
        self.wingman_yaw = self.yaw
    ...
    def pursuit(self):
        logger.critical(self.name + ' pursuit mode engaged')
        self.state = 'Pursuit'
